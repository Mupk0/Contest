...
final class PencilToolView: UIView, ToolProtocol {
    private lazy var toolImageView: UIImageView = {
        let imageView = UIImageView(frame: bounds)
        imageView.autoresizingMask = [.flexibleWidth, .flexibleHeight]
        imageView.contentMode = .scaleAspectFit
        imageView.image = #imageLiteral(resourceName: "pencil")
        return imageView
    }()
    ...
    private lazy var toolTipImageView: UIImageView = {
        ...
        imageView.autoresizingMask = [.flexibleWidth, .flexibleHeight]
        imageView.contentMode = .scaleAspectFit
        imageView.image = #imageLiteral(resourceName: "pencilTip").withRenderingMode(.alwaysTemplate)
    ...
    var color: UIColor {
        didSet {
            tool = PKInkingTool(.pencil, color: color, width: weight)
